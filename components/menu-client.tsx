...
export default function MenuClient({ categories, products, settings, appearance }: MenuClientProps) {
      ...
      <div className="min-h-screen bg-black text-white relative">
        ...
        <div className="relative z-10">
          ...
          <Button
            ...
            className="fixed bottom-6 right-6 bg-yellow-500 hover:bg-yellow-600 text-black rounded-full w-16 h-16 shadow-lg z-50 transition-all duration-300 hover:scale-110"
            size="lg"
          >
